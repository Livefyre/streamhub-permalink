...
HubPermalink.define('base64',['require','exports','module'],function (require, exports, module) {var base64={},chars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";function InvalidCharacterError(a){this.message=a}InvalidCharacterError.prototype=Error();InvalidCharacterError.prototype.name="InvalidCharacterError";
...
HubPermalink.define('streamhub-sdk/collection/clients/bootstrap-client',[
...
HubPermalink.define('streamhub-sdk/collection/streams/archive',[
    'streamhub-sdk/jquery',
    'stream/readable',
...
HubPermalink.define('streamhub-sdk/collection/clients/stream-client',[
    'streamhub-sdk/collection/clients/http-client',
    'inherits'],
...
HubPermalink.define('streamhub-sdk/collection/streams/updater',[
    'inherits',
    'stream/readable',
    'stream/util',
    'streamhub-sdk/collection/clients/bootstrap-client',
...
HubPermalink.define('streamhub-sdk/collection/streams/writer',[
    'stream/writable',
...
HubPermalink.define('streamhub-sdk/collection/streams/featured-archive',[
    'streamhub-sdk/jquery',
    'stream/readable',
    'streamhub-sdk/collection/clients/bootstrap-client',
    'streamhub-sdk/content/state-to-content',
...
HubPermalink.define('streamhub-sdk/collection/featured-contents',[
...
HubPermalink.define('streamhub-sdk/collection/clients/create-client',[
    'streamhub-sdk/collection/clients/http-client',
    'inherits'],
function(LivefyreHttpClient, inherits) {
...
HubPermalink.define('streamhub-sdk/collection/clients/permalink-client',['require','exports','module','streamhub-sdk/collection/clients/http-client','inherits'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-sdk/content/fetch-content',['require','exports','module','streamhub-sdk/content','streamhub-sdk/content/clients/content-client','streamhub-sdk/content/state-to-content'],function (require, exports, module) {var Content = require('streamhub-sdk/content');
...
HubPermalink.define('streamhub-sdk/collection/main',[
    'streamhub-sdk/jquery',
...
HubPermalink.define('streamhub-sdk/collection', ['streamhub-sdk/collection/main'], function (main) { return main; });
...
HubPermalink.define('streamhub-permalink/uri-interpreter',['require','exports','module','jquery','streamhub-sdk/debug','purl','streamhub-sdk/util'],function (require, exports, module) {
...
;
HubPermalink.define('text',{load: function(id){throw new Error("Dynamic load not allowed: " + id);}});
...
HubPermalink.define('streamhub-sdk/ui/command',['require','exports','module','event-emitter','inherits'],function (require, exports, module) {
...
HubPermalink.define('streamhub-sdk/ui/auth-required-command',['require','exports','module','auth','streamhub-sdk/auth','streamhub-sdk/ui/command','inherits','streamhub-sdk/debug','streamhub-sdk/util'],function (require, exports, module) {var auth = require('auth');
...
HubPermalink.define("hgn!streamhub-sdk/ui/templates/button", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");if(_.s(_.f("buttonUrl",c,p,1),c,p,0,14,87,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <a href=\"");_.b(_.t(_.f("buttonUrl",c,p,0)));_.b("\" target=\"_blank\">");_.b(_.t(_.f("buttonLabel",c,p,0)));_.b("</a>");_.b("\n");});c.pop();}if(!_.s(_.f("buttonUrl",c,p,1),c,p,1,0,0,"")){_.b("    ");_.b(_.t(_.f("buttonLabel",c,p,0)));_.b("\n");};return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/ui/button',['require','exports','module','hgn!streamhub-sdk/ui/templates/button','streamhub-sdk/ui/command','inherits','view'],function (require, exports, module) {
...
HubPermalink.define('streamhub-sdk/user-agent',['require','exports','module','streamhub-sdk/util'],function (require, exports, module) {/**
...
HubPermalink.define("hgn!templates/lfwrapper", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define("hgn!templates/container", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-thread-content\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/ui/container',['require','exports','module','jquery','inherits','streamhub-sdk/user-agent','view','hgn!templates/lfwrapper','hgn!templates/container'],function (require, exports, module) {/**
...
HubPermalink.define('streamhub-sdk/ui/util/dom',['require','exports','module','streamhub-sdk/user-agent'],function (require, exports, module) {/**
...
HubPermalink.define("hgn!templates/popover", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-thread-content lf-popover-content\"></div>");_.b("\n" + i);_.b("<div class=\"lf-popover-arrow\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/ui/popover',['require','exports','module','jquery','streamhub-sdk/ui/container','streamhub-sdk/ui/util/dom','inherits','hgn!templates/popover'],function (require, exports, module) {/**
...
HubPermalink.define("hgn!templates/menu/link", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<li data-value=\"");_.b(_.v(_.f("key",c,p,0)));_.b("\" class=\"lf-");_.b(_.v(_.f("key",c,p,0)));_.b(" ");_.b(_.v(_.f("cls",c,p,0)));_.b("\">");_.b(_.v(_.f("str",c,p,0)));_.b("</li>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define("hgn!templates/mobile/navbar", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<button type=\"button\" class=\"lf-menu-back-btn lf-btn lf-btn-sm lf-btn-default\">");_.b(_.t(_.d("strings.backBtn",c,p,0)));_.b("</button>");_.b("\n" + i);_.b("<h3>");_.b(_.t(_.d("strings.title",c,p,0)));_.b("</h3>");_.b("\n" + i);if(_.s(_.f("actionButton",c,p,1),c,p,0,160,264,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <button type=\"button\" class=\"lf-menu-action-btn lf-btn lf-btn-sm\">");_.b(_.v(_.d("strings.actionBtn",c,p,0)));_.b("</button>");_.b("\n");});c.pop();}return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define("hgn!templates/navigablesub", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define("hgn!templates/navigable", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");if(_.s(_.f("topNavEnabled",c,p,1),c,p,0,18,88,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("    <header class=\"lf-menu-head\">");_.b("\n" + i);_.b(_.rp("navbar",c,p,"        "));_.b("    </header>");_.b("\n");});c.pop();}_.b("<div class=\"lf-menu-body\">");_.b("\n" + i);_.b(_.rp("body",c,p,"    "));_.b("</div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/ui/navigable',['require','exports','module','inherits','streamhub-sdk/user-agent','view','hgn!templates/mobile/navbar','hgn!templates/navigablesub','hgn!templates/navigable'],function (require, exports, module) {/**
...
HubPermalink.define('streamhub-sdk/ui/menu/base',['require','exports','module','jquery','inherits','hgn!templates/menu/link','streamhub-sdk/ui/navigable','streamhub-sdk/user-agent'],function (require, exports, module) {/**
...
HubPermalink.define("hgn!templates/loader", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"lf-loader-container\"></div>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define("hgn!templates/menu/share", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<footer class=\"lf-menu-foot\">");_.b("\n" + i);_.b("    <textarea readonly>");_.b(_.v(_.f("permalink",c,p,0)));_.b("</textarea>");_.b("\n" + i);_.b("</footer>");_.b("\n");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/ui/menu/share',['require','exports','module','jquery','streamhub-sdk/ui/menu/base','inherits','livefyre-bootstrap/loader','hgn!templates/loader','hgn!templates/menu/share'],function (require, exports, module) {/**
...
HubPermalink.define('streamhub-sdk/share-format',['require','exports','module'],function (require, exports, module) {/**
...
HubPermalink.define('streamhub-sdk/ui/share-menu',['require','exports','module','streamhub-sdk/jquery','streamhub-sdk/ui/menu/base','inherits','livefyre-bootstrap/loader','streamhub-sdk/debug','streamhub-sdk/ui/menu/share','streamhub-sdk/share-format'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-sdk/ui/share-command',['require','exports','module','streamhub-sdk/jquery','streamhub-sdk/ui/command','streamhub-sdk/debug','inherits','streamhub-sdk/ui/popover','streamhub-sdk/ui/share-menu'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-sdk/ui/share-button',['require','exports','module','streamhub-sdk/ui/hub-button','inherits','streamhub-sdk/ui/share-command'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-permalink/handlers/content',['require','exports','module','streamhub-sdk/collection','streamhub-permalink/default-permalink-content-renderer'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-permalink/permalink',['require','exports','module','streamhub-sdk/collection','streamhub-permalink/enums','event-emitter','inherits','streamhub-sdk/debug','streamhub-permalink/uri-interpreter','streamhub-sdk/util','streamhub-permalink/handlers/content'],function (require, exports, module) {
...
HubPermalink.define('streamhub-sdk/views/streams/more',[
    'inherits',
    'stream/duplex',
    'streamhub-sdk/debug'],
...
HubPermalink.define('streamhub-sdk/views/show-more-button',['inherits', 'streamhub-sdk/view', 'streamhub-sdk/jquery'],
...
HubPermalink.define("hgn!streamhub-sdk/views/templates/list-view", ["hogan"], function(hogan){  var tmpl = new hogan.Template(function(c,p,i){var _=this;_.b(i=i||"");_.b("<div class=\"hub-list\"></div>");_.b("\n" + i);_.b("<div class=\"hub-list-footer\">");_.b("\n" + i);_.b("	<a class=\"hub-list-more\"></a>");_.b("\n" + i);_.b("</div>");return _.fl();;}, "", hogan);  function render(){ return tmpl.render.apply(tmpl, arguments); } render.template = tmpl; return render;});

HubPermalink.define('streamhub-sdk/views/list-view',[
    'streamhub-sdk/jquery',
    'streamhub-sdk/view',
    'inherits',
    'streamhub-sdk/debug',
...
HubPermalink.define('streamhub-sdk/content/views/content-list-view',[
    'streamhub-sdk/jquery',
...
HubPermalink.define('streamhub-permalink/ui/container',['require','exports','module','jquery','inherits','streamhub-sdk/user-agent','view','hgn!templates/lfwrapper','hgn!templates/container'],function (require, exports, module) {/**
 * @fileOverview Container base class which provides the basic functionality for
 * popovers (e.g. showing, hiding, etc)
 */
...
HubPermalink.define('streamhub-permalink/ui/util/dom',['require','exports','module','streamhub-sdk/user-agent'],function (require, exports, module) {/**
 * @fileoverview Dom helpers that are generally unsupported or too specific for jQuery
 */
...
HubPermalink.define('streamhub-permalink/ui/popover',['require','exports','module','jquery','streamhub-permalink/ui/container','streamhub-permalink/ui/util/dom','inherits','hgn!templates/popover'],function (require, exports, module) {/**
 * @fileOverview Popover base class which provides the basic functionality for
 * popovers (e.g. showing, hiding, etc)
 */
...
HubPermalink.define('streamhub-permalink/ui/navigable',['require','exports','module','inherits','streamhub-sdk/user-agent','view','hgn!templates/mobile/navbar','hgn!templates/navigablesub','hgn!templates/navigable'],function (require, exports, module) {/**
 * @fileOverview Navigable view. This optionally adds a nav bar on the top
 * with a back button. It fires events that the NavigableContainer listens for.
 */
...
HubPermalink.define('streamhub-permalink/ui/menu/base',['require','exports','module','jquery','inherits','hgn!templates/menu/link','streamhub-permalink/ui/navigable','streamhub-sdk/user-agent'],function (require, exports, module) {/**
 * @fileOverview Base menu. This provides menu-specific abilities.
 */
...
HubPermalink.define('streamhub-permalink/ui/menu/share',['require','exports','module','jquery','streamhub-permalink/ui/menu/base','inherits','livefyre-bootstrap/loader','hgn!templates/loader','hgn!templates/menu/share'],function (require, exports, module) {/**
 * @fileOverview Flag menu view. This provides all of the flagging options to
 * the user so that they can flag a piece of content.
 */
...
HubPermalink.define('streamhub-permalink/share-menu',['require','exports','module','streamhub-sdk/jquery','streamhub-permalink/ui/menu/base','inherits','livefyre-bootstrap/loader','streamhub-sdk/debug','streamhub-permalink/ui/menu/share'],function (require, exports, module) {'use strict'
...
HubPermalink.define('streamhub-permalink/sharer',['require','exports','module','streamhub-sdk/jquery','streamhub-sdk/debug','streamhub-permalink/ui/popover','streamhub-permalink/share-menu','streamhub-sdk/share-format'],function (require, exports, module) {var $ = require('streamhub-sdk/jquery');
...
HubPermalink.define('text!streamhub-wall/style.css',[],function () { return '.streamhub-media-wall-view {\n    position:relative;\n}\n.streamhub-media-wall-view .hub-wall-column {\n    display: inline-block;\n    vertical-align: top;\n    -moz-box-sizing: border-box;\n    -webkit-box-sizing: border-box;\n    box-sizing: border-box;\n    padding: 5px; }\n';});

HubPermalink.define('streamhub-wall/main',[
    'streamhub-sdk/jquery',
...
HubPermalink.define('streamhub-wall', ['streamhub-wall/main'], function (main) { return main; });

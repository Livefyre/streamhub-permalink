...
describe('streamhub-permalink/permalink', function () {
    ...
    describe('when constructed', function () {
        ...
        it('calls the default handler for a ._set() key, unless it has been .preventDefault\'d', function () {
            throw 'TODO (joao) Implement this!';
        });
        ...
        it('logs and returns early if you try to .preventDefault() it without specifying a key', function () {
            throw 'TODO (joao) Implement this!';
        });
